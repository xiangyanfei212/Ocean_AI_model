...
def create_map(longitude, latitude, variable, variable_u, variable_v, box, vmin=0, vmax= 10, cmap='Blues',
    ...
    variable_u = variable_u[lat_indices[0]:lat_indices[-1], lon_indices[0]:lon_indices[-1]]
    variable_v = variable_v[lat_indices[0]:lat_indices[-1], lon_indices[0]:lon_indices[-1]]
    ...
    q = ax.quiver(longitude[::q_step], latitude[::q_step], variable_u[::q_step, ::q_step], variable_v[::q_step, ::q_step],
                  width=0.005, headwidth=3, transform=proj)
...
if __name__ == '__main__':
    ...
    create_map(longitude, latitude, uv_10, u10, v10, box, vmin=0, vmax= 32, cmap='Blues',
               q_step=15, xstep=2, ystep=2, lat_cff=10, lon_cff=10, title='Surface wind speed')
